...
def display_colored_art(art, show_art=True):
    if not show_art:
        return
    banner_lines = art.split("\n")
    colors = [Fore.RED, Fore.YELLOW, Fore.GREEN, Fore.CYAN, Fore.BLUE, Fore.MAGENTA]
    for line in banner_lines:
        color_line = "".join(colors[i % len(colors)] + char for i, char in enumerate(line))
        print(color_line)
...
def main():
    ...
    display_colored_art(ASCII_ART, args.show_art)
    print(CREATED_BY)
    print(VERSION)
